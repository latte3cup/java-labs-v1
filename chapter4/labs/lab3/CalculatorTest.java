...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        System.out.println(Calculator.circleSize(3.0));
        System.out.println(Calculator.circleLength(3.0));
        
        // TODO: 객체 생성 없이 static 메소드를 호출하여 사각형의 면적을 계산하세요.
        System.out.println(Calculator.squareArea(5,4));
